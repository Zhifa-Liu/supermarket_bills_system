        ...
        <tr>
            <td>
                <form method="post" action="LookupProviderServlet">
                    ...
                    供应商名称：
                    <label><input name="providerName" value="" class="input-text" type="text"></label> &nbsp;&nbsp;&nbsp;&nbsp;
                    供应商描述：
                    <label><input name="providerDesc" value="" class="input-text" type="text"></label>&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="main">
    ...
    <div class="content">
        <table class="list">
            ...
            <%
                List<Provider> result = (List<Provider>) request.getAttribute("proQuery");
