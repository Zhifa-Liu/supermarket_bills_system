        ...
        <tr>
            <td>
                <form method="get" action="LookupBillServlet">
                    商品名称：
                    <label>
                        <input type="text" name="productName" value="" class="input-text" />
                    </label>&nbsp;&nbsp;&nbsp;&nbsp;
                    是否付款：
                    <label>
...
<div class="main">
    ...
    <div class="content">
        <table class="list">
            ...
            <c:forEach items="${requestScope.billQuery}" var="b" varStatus="bs">
                <tr>
                    <td>${b.billId}</td>
                    <td>${b.productName}</td>
                    <td>${b.productDesc}</td>
                    ...
                    <td>
                        <c:forEach items="${requestScope.providers}" var="p">
                            ${b.providerId eq p.providerId}
                            <c:if test="${b.providerId eq p.providerId}">
                                ${p.providerName}
                            </c:if>
                        </c:forEach>
                    </td>
